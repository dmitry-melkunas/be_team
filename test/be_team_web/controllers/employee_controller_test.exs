defmodule BeTeamWeb.EmployeeControllerTest do
  use BeTeamWeb.ConnCase

  import BeTeam.TeamsFixtures

  @create_attrs %{description: "some description", first_name: "some first_name", last_name: "some last_name", role: "some role", surname: "some surname"}
